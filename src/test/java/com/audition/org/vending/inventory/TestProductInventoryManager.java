...
public class TestProductInventoryManager {
	...
	public void shouldLoadProducts() throws ProductOutOfStockException{
		...
		System.out.println("1"+productInventoryManager.getStockCount(1).intValue());
		System.out.println("2"+productInventoryManager.getStockCount(2).intValue());
		System.out.println("3"+productInventoryManager.getStockCount(3).intValue());
	}
